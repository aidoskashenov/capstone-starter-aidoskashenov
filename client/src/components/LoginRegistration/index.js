          ...
          switch (status) {
            ...
            case "Login":
              auth
                ...
                .then((res) => {
                  if (res.status > 400) {
                    throw new Error(`Unable to login ATM!
            ...
            default:
              auth
                ...
                .then((res) => {
                  if (res.status > 400) {
                    throw new Error(`Unable to create an account ATM!
                    Please check your internet connection and/or try again later!
                  `)
                  }
                  return res.json()
      ...
      >
        {({ isSubmitting }) => (
          <Form>
            ...
            <button
              type="submit"
              className="button is-primary ml-2 mt-2"
